...
import {useProviders, useSearchHistory, useTariffs} from '../../hooks';
...
const TariffList: React.FC = () => {
    ...
    const {searchHistory, fetchSearchHistory, deleteSearchItem, clearHistory} = useSearchHistory();
    ...
    const applyFilters = async () => {
        ...
        // Обновляем историю поиска после применения фильтров
        await fetchSearchHistory();
        setShowHistory(false); // Закрываем историю после поиска
    };
    ...
    const handleSelectHistoryItem = async (params: TariffSearchParams) => {
        setFilters(params);
        await searchTariffs(params);
        // Обновляем историю после применения из истории
        await fetchSearchHistory();
