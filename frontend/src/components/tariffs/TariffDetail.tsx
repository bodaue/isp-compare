...
import { Tariff, Provider } from '../../types/provider.types';
            ...
            >
                <div className="connect-modal-content">
                    <div className="connect-info">
                        ...
                        <p>Для подключения тарифа свяжитесь с провайдером {provider.name} одним из следующих способов:</p>
                    </div>
                        ...
                        <div className="contact-item">
                            ...
                            <div className="contact-info">
                                ...
                                <button
                                    ...
                                    onClick={() => copyToClipboard('8-800-XXX-XX-XX')}
                                >
                                    Скопировать номер
                                </button>
                            </div>
